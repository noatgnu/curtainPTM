...
export class UniprotService {
  ...
  async UniprotParserJS(accList: string[]) {
    const parser = new Parser(5, "accession,id,gene_names,protein_name,organism_name,organism_id,length,cc_subcellular_location,sequence,ft_var_seq,cc_alternative_products,ft_domain,xref_string,ft_mod_res,cc_disease,cc_pharmaceutical,ft_mutagen")
